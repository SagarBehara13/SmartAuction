  ...
  render() {
    return(
      <div className="container-fluid">
        <div className="row align-items-center justify-content-center hault-auction" id="addProduct">
          <h2 className="col-12">End The Ongoing Auction Of A Product</h2>
          {
            this.state.loading ? (
              ...
              <div className="col-12 hault-auction-container table-bordered">
                <Form onSubmit={(event) => {
                    ...
                    <br />
                    <Button className="hault-auction-button" type="submit" value="submit">Hault auction</Button>
                </Form>
              </div>
            )
          }
